    ...
    <div class="navbar-translate d-flex justify-content-between w-100 fixed-top">
        <a href="/" class="navbar-brand" itemprop="url">
            <div class="logo-small">
                ...
                <span class="bold-2 d-none d-md-block">AfemaiAssociationOfCanada</span>
            </div>
        </a>
        ...
        <div class="d-flex justify-content-center align-items-center">
            <a href="/members-signup" class="d-none d-lg-block  bold-2 mr-4 btn btn-outline-secondary" itemprop="url">Register</a>
