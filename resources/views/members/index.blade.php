        ...
        <div class="d-flex justify-content-center align-items-center">
            <div class="ml-1 col-md-7 mr-1">
                <div class=" mt-4 mb-4">
                    ...
                    @else
                    <form method="POST" class=" pl-4 pr-4 border bg-white" action="/members-signup">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group bmd-form-group col-md-12 col-12  align-items-center">
                                <select required="true" name="preferred_way_to_contact" id="mySelect" class="form-control ">
                                    ...
                                    <option {{ old("preferred_way_to_contact") === 'email' ? 'selected': ""}} value="email">Email</option>
                                    <option {{ old("preferred_way_to_contact") === 'phone' ? 'selected': ""}} value="phone">Phone</option>
                                </select>
                            </div>
