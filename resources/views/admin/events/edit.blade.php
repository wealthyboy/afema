    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-content">
                ...
                <form enctype="multipart/form-data" method="post" action="{{ route('admin.events.update',['event' => $event->id]) }}" class="form-horizontal">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="title" value="{{ !empty(  $event->title )  ? $event->title : old('title')   }}" class="form-control" id="title" placeholder="title">
                        </div>
                    </div>
                            ...
                            <div class="form-group ">
                                <div class="col-sm-12">
                                    ...
                                    <textarea name="description"
                                        id="description" class="form-control" rows="7">{{$event->description}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div id="{{ $image->id }}" class="j-complete">
                                    <div class="j-preview">
                                        ...
                                        <div id="remove_image" class="remove_image remove-image">
                                            ...
                                            <input type="hidden" class="file_upload_input stored_image_url" value="{{ $event->image }}" name="edit_room_images[{{ $event->id }}][]">
                                        </div>
                                    </div>
                                </div>
                                @endforeach
