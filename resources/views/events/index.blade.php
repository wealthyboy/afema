...
<header class="mb-2">
    <div class="page-header min-vh-75 h-28 position-relative" style="background-image: url(https://afemaiassociationofcanada.com/images/events/DsORTns9siEfCmKLno73OFF6rkoxSeAcriEUJRXQ.jpg); " loading="lazy">
...
<div class="d-none d-md-block">
    <div class="container-fluid">
        ...
        <div class="row mb-2 mt vh-100">
            ...
            <!-- Map Panel -->
            <div id="rightBox-{{$key}}" class="col-lg-7 col-md-12 rounded  {{$loop->iteration % 2 == 0? 'order-1' : 'order-2' }}   card-background-image">
...
<div class="d-block d-sm-none">
    <div class="container-fluid ">
        ...
        <div class="row mb-2 mt vh-100">
            ...
            <!-- Map Panel -->
            <div id="rightBox-{{$key}}" class="col-lg-7 col-md-12   }}   card-background-image">
                <div id="gallery-banner-{{$event->id}}" class="carousel slide" data-ride="carousel">
                    <ol class="carousel-indicators">
                        @foreach($event->images as $key => $image)
                        <li data-target="#gallery-banner-{{$event->id}}" data-slide-to="{{ $key }}" class="{{ $key === 0 ? 'active' : ''}}"></li>
            ...
            <div id="leftBox-{{$key}}" style="z-index: 2;" class="  col-md-5 d-flex flex-column justify-content-center align-items-start bg-light p-5">
                <a href="http://">
                    <h1 class="mb-4 display-4">{{$event->title}} </h1>
                </a>
                <p class="fs-5">
