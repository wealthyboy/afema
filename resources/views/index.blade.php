...
const chart = root.container.children.push(am5.map.MapChart.new(root, {
...
const polygonSeries = chart.series.push(am5.map.MapPolygonSeries.new(root, {
geoJSON: am5geodata_worldLow
}));

polygonSeries.mapPolygons.template.setAll({
fill: am5.color(0x555c64),
stroke: am5.color(0xffffff),
strokeWidth: 1
});

polygonSeries.mapPolygons.template.adapters.add("fill", function(fill, target) {
return am5.ImagePattern.new(root, {
width: 6,
height: 6,
pattern: am5.Circle.new(root, {
radius: 1.5,
fill: am5.color(0x555c64)
})
});
...
chart.set("zoomLevel", 4.5);
chart.set("centerLatitude", 43.6532);
chart.set("centerLongitude", -79.3832);

const pointSeries = chart.series.push(am5.map.MapPointSeries.new(root, {}));
...
radius: 8,
fill: am5.color(0xff6f00),
tooltipText: "Ontario, Canada"
}));
